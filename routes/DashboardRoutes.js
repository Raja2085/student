...
import { FaCalendarAlt } from 'react-icons/fa'; // Import FaCalendarAlt
 ...
 * name        : String - If it's menu item in which you are specifying link, use name ( don't use title for that )
...
export const DashboardMenu = [
    ...
    },
    {
        ...
        icon: 'clipboard-list',
        children: [
            { id: uuid(), link: '/marks', name: 'Marks', icon: 'list' },
            { id: uuid(), link: '/marks/add', name: 'Add Marks', icon: 'plus-circle' },
        ],
    },
    {
        id: uuid(),
        title: "Events",
        icon: <FaCalendarAlt />, // Now properly defined
        link: "/events" // Ensure there is an events folder with page.js
    },
    {
        id: uuid(),
